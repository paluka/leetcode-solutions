...
fn main() {
    ...
    let solution1_sum = two_sum(&nums1, target1);
    let solution1_sum1 = two_sum1(&nums1, target1);
    ...
    let solution2_sum = two_sum(&nums2, target2);
    let solution2_sum1 = two_sum1(&nums2, target2);
    ...
    let solution3_sum = two_sum(&nums3, target3);
    let solution3_sum1 = two_sum1(&nums3, target3);
    ...
    let solution4_sum = two_sum(&nums4, target4);
    let solution4_sum1 = two_sum1(&nums4, target4);
    ...
    let solution5_sum = two_sum(&nums5, target5);
    let solution5_sum1 = two_sum1(&nums5, target5);
